...
window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/lib/node-jquery.js");
...
function create(window) {
  ...
  if(window == null ) {
    window = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jsdom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).jsdom().createWindow();
    // assume window is a jsdom instance...
    // jsdom includes an incomplete version of XMLHttpRequest
    window.XMLHttpRequest = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xmlhttprequest'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).XMLHttpRequest;
    // trick jQuery into thinking CORS is supported (should be in node-XMLHttpRequest)
    window.XMLHttpRequest.prototype.withCredentials = false;
    
    if(window.location == null) {
      window.location = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'location'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));  
    }

    if(window.navigator == null) {
      window.navigator = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'navigator'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
    }
  }
